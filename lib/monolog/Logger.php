...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * Directly read or write the extra
     */
    ...
    /**
     * Prints variables at the DEBUG level.
     *
     * This method allows for print some variables that not only array
     * Like: xml json html yaml 
     *
     * @param string $message The log message
     * @param string|array $variables The debug print var
     * @param array $context The log context
     */
    public function print($message, $variables, array $context = []): void
    {
